...
const About = () => {
  return (
    <div className='about' id='about'>
        ...
        <Link to='/about' onClick="container"><img src={about3} alt='' className='about-img'/></Link>
        </div>
        <div className="about-right">
            <Link to='/about' onClick="container"><p className='para1'>Who We Are</p></Link>
            ...
            <Link to='/about' onClick="container"><button className='abt-btn'>Read More</button></Link>
        </div>
    </div>
  )
}
